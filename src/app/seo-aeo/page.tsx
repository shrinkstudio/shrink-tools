...
const LOADING_MESSAGES = [
  "Scanning meta tags and Open Graph...",
  "Analysing heading structure...",
  "Checking schema markup...",
  "Evaluating AI citability...",
...
export default function SeoAeoPage() {
  ...
  const handleAnalyze = async (url: string) => {
    ...
    setError("");
    setAnalyzedUrl(url);
    posthog.capture("analysis_started", { domain: url, tool: "seo-aeo" });

    try {
      const response = await fetch("/api/analyze-seo-aeo", {
        method: "POST",
